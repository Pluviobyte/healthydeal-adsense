...
toc: true
featured: false
canonical: "https://example.com/healthy-recipes/healthy-tuna-salad-recipe/"
ads:
  top: true
  mid: false
  bottom: true
...
Store using methods from [Best Meal Prep Containers](/meal-prep/best-meal-prep-containers/) to keep tuna salad fresh all week.
